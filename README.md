# (Unofficial) eBay API client (PHP) - Buy / Marketplace Insights
...
Please refer to [eBay's documentation](https://developer.ebay.com/api-docs/buy/marketplace-insights/overview.html) for detailed API behaviour explanation.
...
Starting from version v1_beta.2.2, this project will match according eBay API's versioning. Should you found a matching 
...
Client::configure(
    new \GuzzleHttp\Client([
        'base_uri' => 'https://api.ebay.com/buy/marketplace_insights/v1/',
        'headers'=>[
